...
data = load('RESULTS/ExhaustiveFeatureSearch-NaiveBayes-20.mat');
...
nFeaturesMax = max(nFeatures) - numel(excludeFeature);
...
fid = fopen('RESULTS/ExhaustiveSearchLatex-excluded-features.tex','w');
% Number of features, 
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-performance-overview-excluded-features.pdf','pdf')
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-performance-overview-alt-excluded-features.pdf','pdf')
...
save('RESULTS/exhaustiveSearchResultsSummary-excluded-features.mat', ...
     'bestNfeatureSets', ...
     'bestNfeatureSetsMean', ...
     'bestNfeatureSetsName', ...
     'bestNfeatureSetsSTD', ...
