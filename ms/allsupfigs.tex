...
%
% To generate depth figures:
% drawAllNeuronsSide.m
%
% To generate featuer space figures:
% plotAllFeaturesForSupplementary.m


\begin{figure}
  \centering
  \fbox{\includegraphics[scale=1]{Figures/SupFig1/CB2-all-cells-1.eps}}
  \label{CB2planar}
...
\bottomrule
  \end{tabular}
\label{CB2filenames}
  \caption{List of CB2 file names in data set.}
...
\begin{figure}
  \centering
  \fbox{\includegraphics[scale=1]{Figures/SupFig2/CB2-stratification-depth-16}}
...
\begin{figure}
  \centering
  \fbox{\includegraphics[scale=1]{Figures/SupFig2/DRD4-stratification-depth-16}}
  \caption{Stratification depth profiles for DRD4. See Figure
    \ref{CB2depth} for details.}
\end{figure}
...
\begin{figure}
  \centering
  \fbox{\includegraphics[scale=1]{Figures/SupFig2/Hoxd10-stratification-depth-16}}
  \caption{Stratification depth profiles for Hoxd10. See Figure
    \ref{CB2depth} for details.}
\end{figure}
