...
\begin{table}
  ...
  {\renewcommand{\arraystretch}{1.3} \begin{tabular}{lp{8.5cm}}
      ...
      DA: Dendritic Area & {\footnotesize Area of dendritic arbor projected on the XY-plane, calculated using the convex hull \dd}\\
      DD: Dendritic Density & {\footnotesize TDL / DA \dd}\\
      DDi: Dendritic Diameter & {\footnotesize  Largest distance between two points on dendritic arbor \dd}\\
      DBP: Density of Branch Points &  {\footnotesize  NBP / DA \dd}\\
      FD: Fractal Dimension & {\footnotesize  Fractal-based dendritic complexity measure \dd}\\
      MBA: Mean Branch Angle &  {\footnotesize  Mean angle between branches}\\
      ...
      SA: Soma Area & {\footnotesize  Area of the soma projected onto the XY-plane \dd}\\
...
\caption{Features calculated from each RGC. \dd\ marks features which are calculated from 2D representations; all other measures are derived from the 3D representation of the tree.}
...
\newcommand{\xx}[1]{\rotatebox{90}{\makebox[8mm][l]{\footnotesize #1}}}
% 20 reps
\begin{table}
\centering
\begin{tabular}{rcccccccccccccccc}
\toprule
N & \% Correct  & \xx{BD} & \xx{BA} & \xx{DA} & \xx{DD} & \xx{DDi} & \xx{DBP} & \xx{FD} & \xx{MBA} & \xx{MSL} &
\xx{MST} & \xx{MTSL} & \xx{NBP} & \xx{SA} & \xx{SD} & \xx{TDL}\\
\midrule
1 &  $65 \pm 2$  &  &  &  &  &  &  &  &  &  &  & $\bullet$ &  &  &  & \\
2 &  $73 \pm 2$  &  &  &  &  &  & $\bullet$ &  &  &  &  &  &  & $\bullet$ &  & \\
3 &  $79 \pm 3$  &  &  &  &  &  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ &  & \\
4 &  $81 \pm 3$  &  &  & $\bullet$ &  &  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ &  & \\
5 &  $83 \pm 4$  &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ &  & \\
6 &  $84 \pm 3$  &  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ &  & \\
7 &  $86 \pm 3$  &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & \\
8 &  $86 \pm 3$  &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & \\
9 &  $86 \pm 2$  & $\bullet$ &  & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
10 & $85 \pm 2$  &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
11 & $85 \pm 2$  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
12 & $85 \pm 2$  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
13 & $84 \pm 2$  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
14 & $83 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
15 & $82 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
\bottomrule
\end{tabular}
...
\hline
1  & $56 \pm 1$  &  &  &  &  &  &  & $\bullet$ &  &  &  &  &  &  & \\
2  & $67 \pm 2$  &  &  &  &  &  &  & $\bullet$ &  &  &  &  &  & $\bullet$ & \\
3  & $76 \pm 2$  &  &  &  & $\bullet$ &  &  &  &  &  &  &  &  & $\bullet$ & $\bullet$\\
4  & $81 \pm 2$  & $\bullet$ &  &  &  &  & $\bullet$ &  &  &  &  &  &  & $\bullet$ & $\bullet$\\
5  & $82 \pm 3$  & $\bullet$ &  &  &  &  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$\\
6  & $82 \pm 2$  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$\\
7  & $80 \pm 2$  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ &  &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$\\
8  & $80 \pm 2$  & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  & $\bullet$ &  &  & $\bullet$ & $\bullet$\\
9  & $79 \pm 2$  & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$\\
10 & $78 \pm 2$  & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
11 & $77 \pm 2$  & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
12 & $75 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
13 & $73 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
14 & $72 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
\bottomrule
\end{tabular}
...
% References for Gulyas are:
% "Convergence of excitatory and inhibitory inputs onto CCK-containing
% basket cells in the CA1 area of the rat hippocampus"
% Matyas et al 2004
% 
% "Total Number and Ratio of Excitatory and Inhibitory Synapses
% Converging onto Single Interneurons of Different Types in the CA1
% Area of the Rat Hippocampus"
% Gulyas et al 1999

%
% loadGulyas
% runExhaustiveFeatureSearchGulyas
% analyseExhaustiveFeatureSearchGulyas

\begin{table}
\centering
\begin{tabular}{ccllllllllllll}
\toprule
N & \% Correct & \xx{BA} & \xx{DA} & \xx{DD} & \xx{DDi} & \xx{DBP} & \xx{FD} & \xx{MBA} & \xx{MSL} & \xx{MST} & \xx{MTSL} & \xx{NBP} & \xx{TDL}\\
\midrule
 1 & $57 \pm 2$  &  &  &  &  &  &  &  &  &  &  &  & $\bullet$\\
 2 & $67 \pm 2$  &  &  &  &  &  & $\bullet$ &  &  &  &  &  & $\bullet$\\
 3 & $69 \pm 2$  &  &  & $\bullet$ &  &  &  &  &  & $\bullet$ &  &  & $\bullet$\\
 4 & $71 \pm 2$  &  &  &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
 5 & $73 \pm 2$  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
 6 & $75 \pm 2$  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
 7 & $74 \pm 2$  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
 8 & $74 \pm 2$  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
 9 & $73 \pm 2$  & $\bullet$ & $\bullet$ &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
10 & $73 \pm 2$  & $\bullet$ & $\bullet$ &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
11 & $73 \pm 2$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
12 & $70 \pm 3$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
\bottomrule
\end{tabular}
...
% loadFeldemeyer
% runExhaustiveFeatureSearchFeldemeyer
% analyseExhaustiveFeatureSearchFeldemeyer
...
\midrule
 1 & $60 \pm 3$  &  &  &  &  &  &  &  &  &  &  & $\bullet$ & \\
 2 & $67 \pm 5$  &  &  &  &  &  &  &  & $\bullet$ &  &  & $\bullet$ & \\
 3 & $73 \pm 6$  & $\bullet$ &  & $\bullet$ &  &  &  &  &  &  &  & $\bullet$ & \\
 4 & $73 \pm 6$  & $\bullet$ &  & $\bullet$ &  & $\bullet$ &  &  &  &  &  & $\bullet$ & \\
 5 & $73 \pm 3$  & $\bullet$ &  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ &  &  & $\bullet$ & \\
 6 & $73 \pm 2$  & $\bullet$ & $\bullet$ &  & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
 7 & $73 \pm 5$  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ &  &  & $\bullet$ &  &  & $\bullet$ & $\bullet$\\
 8 & $74 \pm 4$  & $\bullet$ &  &  & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$\\
 9 & $75 \pm 7$  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
10 & $75 \pm 4$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
11 & $75 \pm 4$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
12 & $74 \pm 4$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
\bottomrule
\end{tabular}
...
% getConfusionMatrixLatexFeldemeyer
