...
%
% Using: dendriticField fractalDimensionBoxCounting meanSegmentLength
% meanSegmentTortuosity meanTerminalSegmentLength totalDendriticLength
% we get 74.8 +/- 2.2 % prediction rate
...
\toprule
1 & $57.0 \pm 1.9\,\%$  &  &  &  &  &  &  &  &  &  &  &  & $\bullet$\\
2 & $66.8 \pm 1.8\,\%$  &  &  &  &  &  & $\bullet$ &  &  &  &  &  & $\bullet$\\
3 & $70.1 \pm 2.6\,\%$  &  &  &  &  &  &  & $\bullet$ &  & $\bullet$ &  &  & $\bullet$\\
4 & $72.7 \pm 2.9\,\%$  &  &  & $\bullet$ &  &  &  &  & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
5 & $74.1 \pm 2.0\,\%$  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
6 & $74.8 \pm 2.2\,\%$  &  & $\bullet$ &  &  &  & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
7 & $74.9 \pm 2.1\,\%$  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  &  & $\bullet$\\
8 & $74.5 \pm 2.0\,\%$  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$\\
9 & $73.8 \pm 2.8\,\%$  & $\bullet$ & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
10 & $73.1 \pm 2.3\,\%$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
11 & $72.5 \pm 2.3\,\%$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ &  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
12 & $69.0 \pm 2.9\,\%$  & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$ & $\bullet$\\
\bottomrule
\end{tabular}
\caption{Exhaustive feature search using the Gulyas data set.  Using same format
  as Table~\ref{tab:performance}. \textbf{THIS IS PRELIMINARY DATA} }
\end{table}
...
\hline
 ...
 & & cb & cr & cck & pv & pc\\
\cline{3-7}
\multirow{5}{*}{\rotatebox{90}{True Class}}& cb & 11 & 4 & 1 & 2 & 0\\
& cr & 5 & 21 & 1 & 2 & 0\\
& cck & 1 & 0 & 12 & 1 & 0\\
& pv & 3 & 1 & 2 & 14 & 0\\
& pc & 0 & 0 & 0 & 0 & 18\\
