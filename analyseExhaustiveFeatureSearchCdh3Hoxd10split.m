...
data = load('RESULTS/ExhaustiveFeatureSearch-Cdh3-Hoxd10-split-NaiveBayes-20.mat');
...
fid = fopen('RESULTS/ExhaustiveSearchLatex-Cdh3-Hoxd10-split.tex','w');
% Number of features, 
...
fid = fopen('RESULTS/ExhaustiveFeatureSearchPick-Cdh3-Hoxd10-split.csv','w');
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-Cdh3-Hoxd10-split-performance-overview.pdf','pdf')
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-Cdh3-Hoxd10-split-performance-overview-alt.pdf','pdf')
...
save('RESULTS/exhaustiveSearchResultsSummary-Cdh3-Hoxd10-split.mat', ...
     'bestNfeatureSets', ...
     'bestNfeatureSetsMean', ...
     'bestNfeatureSetsName', ...
     'bestNfeatureSetsSTD', ...
