...
% data = load('RESULTS/ExhaustiveFeatureSearch-Feldmeyer-NaiveBayes-20.mat');
data = load('RESULTS/ExhaustiveFeatureSearch-Feldmeyer-NaiveBayes-5.mat');
% data = load('RESULTS/ExhaustiveFeatureSearch-Feldmeyer-NaiveBayes-1.mat');
...
fid = fopen('RESULTS/ExhaustiveSearchLatex-Feldmeyer.tex','w');
% Number of features, 
...
fid = fopen('RESULTS/ExhaustiveFeatureSearchPick-Feldmeyer.csv','w');
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-Feldmeyer-performance-overview.pdf','pdf')
...
saveas(gcf,'FIGS/ExhaustiveFeatureSearch-Feldmeyer-performance-overview-alt.pdf','pdf')
...
save('RESULTS/exhaustiveSearchResultsSummary-Feldmeyer.mat', ...
     'bestNfeatureSets', ...
     'bestNfeatureSetsMean', ...
     'bestNfeatureSetsName', ...
     'bestNfeatureSetsSTD', ...
