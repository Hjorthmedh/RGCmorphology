...
nWorkers = 4;
nFolds = 10; % 5; --- Some group has so few cells that we have to
             % do more folds, to avoid a case where there are no
             % training examples of the cells in question
nRep = 5;
...
fName = sprintf('RESULTS/ExhaustiveFeatureSearch-Feldmeyer-NaiveBayes-%d.mat',nRep);
